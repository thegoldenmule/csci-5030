...
**Email** [benjamin.jordan@slu.edu](mailto:benjamin.jordan@slu.edu)

**Discord** [https://discord.gg/2DBgnzH3](https://discord.gg/2DBgnzH3)

**Course Website** [https://github.com/thegoldenmule/csci-5030](https://github.com/thegoldenmule/csci-5030)
...
_An overview of software development at a graduate level, including software engineering processes, software design and architecture, testing and quality assurance, and selected other topics of interest to software practitioners._
...
- If work is not pushed to GitHub, it is incomplete.
...
When readings are assigned, they should be completed by the next class as they are part of the group discussion. Lectures or discussions may not make sense without having read the assigned material.

#### Assignments

Assigments will generally be code or documentation contributions, submitted via git and focused toward the semester project.

- All assignment due dates will be specified with the work. Usually, but not always, this work will be done on a Sprint schedule and will be due within a week or two.
...
Exams will be in the form of _releases_, i.e. deliveries of a software product. There are four releases, given in the `Calendar` section below.
